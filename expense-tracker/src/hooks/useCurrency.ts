...
export const useCurrency = () => {
  ...
  useEffect(() => {
    ...
    // Subscribe to Firebase user settings
  ...
  // Format an amount that is already known to be in Base currency to Target currency
